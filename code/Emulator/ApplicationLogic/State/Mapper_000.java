...
public class Mapper_000 extends Mapper{
	...
	private Mapper_000(Integer prgBanks, Integer chrBanks) {
		super(prgBanks, chrBanks);
	}
	

	//Punto di ingresso globale all'istanza
	public static Mapper_000 getIstance(Integer prgBanks, Integer chrBanks) {
		if(Map==null) {
			synchronized(Mapper_000.class) {
				if(Map==null) {
					Map = new Mapper_000(prgBanks,chrBanks);
				}
			}
		}
		return Map;
